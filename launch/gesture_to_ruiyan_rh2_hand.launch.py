...
def launch_setup(context, *args, **kwargs):
    ...
    - Hand interpreter subscribes to: /hand_gesture and publishes: /ruiyan_rh2_hand_joint_position_controller/commands
    - ros2_control → /ruiyan_rh2_hand_joint_position_controller/commands
