...
def launch_setup(context, *args, **kwargs):
    ...
    - Hand interpreter subscribes to: /hand_gesture and publishes: /inspire_rh56_hand_joint_position_controller/commands
    - ros2_control → /inspire_rh56_hand_joint_position_controller/commands
